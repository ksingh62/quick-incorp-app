    ...
    <div className="container mx-auto p-6">
      ...
      {formSubmitted ? (
        ...
        <form
          ...
          className="bg-gray-900 p-6 rounded-lg shadow-md text-gray-100"
        >
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring focus:ring-sky-200 focus:ring-opacity-50 text-gray-900"
            />
            {errors.subject && (
